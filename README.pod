...
This module came out of an answer to L<Is Try::Tiny still recommended 
for exception handling in Perl 5.14 or later?|http://stackoverflow.com/a/10374265/2766176>
which I expanded from L<Return error objects instead of throwing exceptions|http://www.effectiveperlprogramming.com/2011/10/return-error-objects-instead-of-throwing-exceptions/>
from L<The Effective Perler| http://www.effectiveperlprogramming.com/>.

=head2 Documentation

To read about L<ReturnValue>, look at the embedded documentation 
...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/ReturnValue> or 
L<MetaCPAN|http://www.metacpan.org/module/ReturnValue>:

=over 4

=item *	L<http://search.cpan.org/>

=item *	L<http://www.metacpan.org/module/ReturnValue>
...
=item *	L<https://github.com/briandfoy/ReturnValue/issues>
